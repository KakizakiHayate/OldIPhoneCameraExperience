...
| **次に着手すべきIssue** | #50（PhotoEditorViewModel + 編集画面UI） |
| **完了テスト数** | 150 |
| **最終更新** | 2026-02-20 |
...
| **Phase 8** | #44 | 動画撮影ViewModel + UI | 🔵 進行中 | | 23/22 |
| **Phase 9** | #45 | アスペクト比モデル + Service対応 | 🔵 進行中 | | 17/17 |
| **Phase 9** | #46 | アスペクト比UI | 🔵 進行中 | | 10/13 |
| **Phase 10** | #47 | フラッシュUI改善 + カメラ切替ボタン移動 | 🔵 進行中 | | 10/12 |
| **Phase 11** | #48 | PhotoEditorService | 🔵 進行中 | | 16/16 |
| **Phase 11** | #49 | トリミング機能 | 🔵 進行中 | | 15/15 |
| **Phase 11** | #50 | PhotoEditorViewModel + 編集画面UI | 🔲 未着手 | | 0/27 |
