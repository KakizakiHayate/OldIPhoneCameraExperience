...
| 項目 | 値 |
|------|-----|
| **現在のPhase** | Phase 11: 写真編集 |
| **次に着手すべきIssue** | — （Phase 11完了） |
| **完了テスト数** | 177 |
| **最終更新** | 2026-02-20 |
...
| **Phase 7** | #40 | ズーム基盤 — CameraService + CameraViewModel | 🔵 進行中 | #51 | 10/10 |
| **Phase 7** | #41 | ズームUI — ピンチジェスチャー + インジケーター | 🔵 進行中 | #52 | 12/12 |
| **Phase 8** | #42 | 動画撮影基盤 — CameraService拡張 | 🔵 進行中 | #53 | 17/17 |
| **Phase 8** | #43 | 動画フィルター後処理 — FilterService拡張 | 🔵 進行中 | #54 | 11/11 |
| **Phase 8** | #44 | 動画撮影ViewModel + UI | 🔵 進行中 | #55 | 23/22 |
| **Phase 9** | #45 | アスペクト比モデル + Service対応 | 🔵 進行中 | #56 | 17/17 |
| **Phase 9** | #46 | アスペクト比UI | 🔵 進行中 | #57 | 10/13 |
| **Phase 10** | #47 | フラッシュUI改善 + カメラ切替ボタン移動 | 🔵 進行中 | #58 | 10/12 |
| **Phase 11** | #48 | PhotoEditorService | 🔵 進行中 | #59 | 16/16 |
| **Phase 11** | #49 | トリミング機能 | 🔵 進行中 | #60 | 15/15 |
| **Phase 11** | #50 | PhotoEditorViewModel + 編集画面UI | 🔵 進行中 | #61 | 27/27 |
