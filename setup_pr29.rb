...
# CameraScreen.swift
puts "Adding CameraScreen.swift..."
views_group = find_or_create_group(project, ['OldIPhoneCameraExperience', 'Views'])
add_file_to_target(project, views_group, 'CameraScreen.swift', 'OldIPhoneCameraExperience')
